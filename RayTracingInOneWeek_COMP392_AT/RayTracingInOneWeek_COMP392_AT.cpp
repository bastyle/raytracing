...
color ray_color_triangle(const ray& r) {
   ...
   // if (hit_triangle(point3(-1.5, -2, -2), point3(1.7, 0, -3), point3(0.5, 2, -2), r)) {
    if (hit_triangle(point3(-1, 0, -2), point3(1, 0, -2), point3(0, 2, -2), r)) {
        return color(0, 1, 0);
...
bool hit_quad(const point3& v0, const point3& v1, const point3& v2, const point3& v3, const ray& r) {
    // First Triangle (v0, v1, v2)
    triangle tri1(v0, v1, v2);
    hit_record rec1{};
    if (tri1.hit(r, 0.0, 10.0, rec1)) {
        return true;
    }
    ...
    hit_record rec2{};
    return tri2.hit(r, 0.0, 10.0, rec2);
}

color ray_color_quad(const ray& r) {
    ...
    if (hit_quad(v0, v1, v2, v3, r)) {
        return color(0, 1, 0); // Green color for the quad
    }
...
bool hit_quad2(const point3& v0, const point3& v1, const point3& v2, const point3& v3, const ray& r) {
    // First Triangle (v0, v1, v2)
...
color ray_color_quad2(const ray& r) {
    // Vertices of the quad
    point3 v0(-1, -1, -2);
    point3 v1(1, -1, -2);
    point3 v2(1, 1, -2);
    //point3 v3(-1, 1, -2);
    point3 v3 = point3(-1*v1.x(),-1*v1.y(),v1.z());
...
//    Listing9_HOF(frct);
    ...
    //Listing9_HOF(frct);
    //Listing9_HOF(ray_color_quad);
    Listing9_HOF(ray_color_quad2);
}